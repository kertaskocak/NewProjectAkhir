...
public class HomeView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnTransaksi.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jLabel5.setText("Aplikasi Catatan Kas adalah aplikasi untuk mencatat");

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel6.setText("semua kegiatan transaksi anda. Jangan sampai anda");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel7.setText("merasakan kerugian karena tidak mencatat semua");

        jLabel8.setText("pemasukan dan pengeluaran Anda.");
    ...
    private void btnTransaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTransaksiActionPerformed
        // TODO add your handling code here:
            RincianView rv = new RincianView();//memanggil frame 
            rv.setLocationRelativeTo(null);//mengeset frame di tengah
            rv.setVisible(true);//menampilkan frame yg di tuju
            rv.pack();
